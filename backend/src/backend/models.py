...
class Property(models.Model):
    ...
    property_type = models.CharField(
        _("property type"), max_length=20, choices=PROPERTY_TYPES
    )
    status = models.CharField(
        _("status"), max_length=20, choices=STATUS_CHOICES, default="on_market"
    )

    # Pricing and Size
    price = models.DecimalField(_("price"), max_digits=12, decimal_places=2)
    size = models.DecimalField(
        _("size"), max_digits=10, decimal_places=2
    )  # in square feet
